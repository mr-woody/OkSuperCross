...
class SuperCrossTransform extends Transform {
    ...
    SuperCrossTransform(Project project, IServiceGenerator serviceGenerator) {
    ...
    @Override
    String getName() {
        return SuperCrossTransform.class.getSimpleName()
    }
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        println "SuperCrossTransform-->transform"
